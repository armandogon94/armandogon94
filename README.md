...
| [Sentiment: RoBERTa vs TF-IDF](https://github.com/armandogon94/Sentiment-RoBERTa) | PyTorch, transformers, MPS | Fine-tuning beats classical NLP by **9.0 points on the same rows** (0.9600 vs 0.8700, McNemar p = 2.99e-16), and a layer probe shows sentiment is **already decodable at block 9 of 12** |
